document.addEventListener('DOMContentLoaded', () => {
    ...
    socket.on('vote json', data => {
        var votedata = data;
        console.log("socket json data is: ", votedata);
        //var jvotedata = JSON.parse(votedata);
        //console.log(jvotedata);

        // Rebuilds the D3 graph using the new data
        /*global d3 */
        ...
        svg.selectAll('text')
            ...
            .attr('x', function(d, i) {
              return i*(barchart_width/votedata.length) + (barchart_width/votedata.length - bar_padding) / 2;
            })
            .attr('y', function(d) {
